...
const API_URL = 'http://localhost:3001/api/cemig';
...
export const getContratos = async () => {
  try {
    ...
    console.error('Erro ao buscar contratos da CEMIG:', error);
    throw error;
  }
};
...
export const getContratoById = async (id) => {
  try {
    ...
    console.error(`Erro ao buscar contrato CEMIG com id ${id}:`, error);
    throw error;
  }
};
...
export const createContrato = async (contratoData) => {
    try {
        ...
        console.error('Erro ao criar contrato CEMIG:', error);
        throw error;
    }
};
...
export const updateContrato = async (id, contratoData) => {
    try {
        ...
        console.error(`Erro ao atualizar contrato CEMIG com id ${id}:`, error);
        throw error;
    }
};
...
export const deleteContrato = async (id) => {
  try {
    ...
    console.error(`Erro ao deletar contrato CEMIG com id ${id}:`, error);
    throw error;
  }
};
